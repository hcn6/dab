...
string = f"!python t2t_decoder.py --data_dir={train_data_dir} --problem={problem} --hparams_set={hparams_set} --model={model} --decode_hparams={decode_hparams}  --decode_from_file={decode_from_file} --decode_to_file={decode_to_file} --output_dir={train_output_dir} --use_tpu={use_tpu} --cloud_tpu_name=grpc://{TPU_ADDRESS}:8470"
